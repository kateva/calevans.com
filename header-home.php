 ...
 *
 * This will include a full-width area for a hero graphice
 *
...
<div id="page">
  ...
  <div class="container-fluid no-gutters top-bar">
    <div class="container">
  ...
  <div class="container-fluid no-gutters home-header">
    <div class="full-photo">
      <div class="container header-photo">
        <div class="jumbotron">
          <div class="title1 large-font text-center">[ SPEAKER ]</div>
          <div class="title2 large-font text-center">[ AUTHOR ]</div>
          <div class="title3 large-font text-center">[ TRAINER ]</div>
          <div class="title4 large-font text-center">[ DEVELOPER ]</div>
          <div class="title5 large-font text-center">[ CAL EVANS ]</div>
        </div>
